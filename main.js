...
class DicomDeidentifier {
    ...
    getDefaultTagConfigurations() {
        ...
        return {
            ...
            '00100010': { ifPresent: 'scramble', ifNotPresent: 'unchanged', presentValue: '', notPresentValue: '', description: 'Patient Name' },
            ...
            '00080020': { ifPresent: 'unchanged', ifNotPresent: 'replace', presentValue: '', notPresentValue: '20000101', description: 'Study Date' },
            '00080030': { ifPresent: 'unchanged', ifNotPresent: 'unchanged', presentValue: '', notPresentValue: '', description: 'Study Time' },
